  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center px-4 py-12">
      <div className="w-full max-w-sm mx-auto">
        ...
        {/* Redirect message */}
        {redirectMessage && (
          <div className="mb-4 bg-teal-50 border border-teal-100 rounded-md px-4 py-3 flex gap-2.5">
        ...
        <div className="bg-white rounded-md shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-6">
            {/* Error */}
            {error && (
              <div className="mb-4 bg-red-50 border border-red-100 rounded-md px-3 py-2.5">
            ...
            {mode === 'password' && (
              <form onSubmit={handlePasswordSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3 bg-teal-600 hover:bg-teal-700 active:bg-teal-800 disabled:opacity-50 text-white font-semibold rounded-md transition-colors"
                >
